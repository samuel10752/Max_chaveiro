...
<body>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Treinado para trabalhar com uma variedade de fechaduras, incluindo mecânicas e eletrônicas.
            </p>
            <div>
              <a href="#portfolio">
                Mais informação
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="Recursos/assets/images/card_sobre/about-img.png" alt="">
          </div>
        </div>
      </div>
  ...
  <!-- <section class="service_section layout_padding">
    <div class="container">
      <div class="d-flex flex-column align-items-end">
        ...
        <p>
          Aqui mexemos com varios tipos de fechaduras, como em casos de perda e temos chaveiros personalizados.
        </p>
      </div>
    </div>
    <div class="container">
      <div class="service_container layout_padding2">
        ...
        <div class="box">
          <div class="img-box">
            <img src="Recursos/assets/images/card_serviços/reparar.png" alt="" class="img-1">
            <img src="Recursos/assets/images/card_serviços/reparar_blue.png
              " alt="" class="img-2">
          </div>
          <div class="name">
            <h6>
        ...
        <div class="box">
          <div class="img-box">
            <img src="Recursos/assets/images/card_serviços/personalizados.png" alt="" class="img-1">
            <img src="Recursos/assets/images/card_serviços/personalizados_blue.png" alt="" class="img-2">
          </div>
          <div class="name">
            <h6>
              Personalizados
        ...
        <div class="box">
          <div class="img-box">
            <img src="Recursos/assets/images/card_serviços/empresas.png" alt="" class="img-1">
            <img src="Recursos/assets/images/card_serviços/empresas_blue.png" alt="" class="img-2">
          </div>
          <div class="name">
            <h6>
              Empresas
        ...
        <div class="box">
          <div class="img-box">
            <img src="Recursos/assets/images/card_serviços/cofre.png" alt="" class="img-1">
            <img src="Recursos/assets/images/card_serviços/cofre_blue.png" alt="" class="img-2">
          </div>
          <div class="name">
            <h6>
              Cofres
        ...
        <div class="box">
          <div class="img-box">
            <img src="Recursos/assets/images/card_serviços/fechaduras.png" alt="" class="img-1">
            <img src="Recursos/assets/images/card_serviços/fechaduras_blue.png" alt="" class="img-2">
          </div>
          <div class="name">
            <h6>
              fechaduras
  ...
  <section class="portfolio_section">
    <div class="container">
      ...
      <p>
        Certificação de treinamento especial na área, licença e registro como
        chaveiro.
      </p>
      <div class="layout_padding2-top">
        <div class="row">
          <div class="col-md-4">
            <div class="img-box">
              <img src="Recursos/assets/images/card_portifolio/p-1.png" alt="">
              <a href="https://www.instagram.com/max_chaveiro/">
                <img src="Recursos/assets/icon/icon_card_portifollio/link.png" alt="">
              </a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="img-box">
              <img src="Recursos/assets/images/card_portifolio/p-2.png" alt="">
              <a href="https://www.instagram.com/max_chaveiro/">
                <img src="Recursos/assets/icon/icon_card_portifollio/link.png" alt="">
              </a>
            </div>
          ...
          <div class="col-md-4">
            <div class="img-box">
              <img src="Recursos/assets/images/card_portifolio/p-3.png" alt="">
              <a href="https://www.instagram.com/max_chaveiro/">
                <img src="Recursos/assets/icon/icon_card_portifollio/link.png" alt="">
              </a>
            </div>
          ...
          <div class="col-md-4">
            <div class="img-box">
              <img src="Recursos/assets/images/card_portifolio/p-4.png" alt="">
              <a href="https://www.instagram.com/max_chaveiro/">
                <img src="Recursos/assets/icon/icon_card_portifollio/link.png" alt="">
              </a>
            </div>
          ...
          <div class="col-md-4">
            <div class="img-box">
              <img src="Recursos/assets/images/card_portifolio/p-5.png" alt="">
              <a href="https://www.instagram.com/max_chaveiro/">
                <img src="Recursos/assets/icon/icon_card_portifollio/link.png" alt="">
              </a>
            </div>
          ...
          <div class="col-md-4">
            <div class="img-box">
              <img src="Recursos/assets/images/card_portifolio/p-6.png" alt="">
              <a href="https://www.instagram.com/max_chaveiro/">
                <img src="Recursos/assets/icon/icon_card_portifollio/link.png" alt="">
              </a>
            </div>
  ...
  <section class="contact_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="layout_padding-top layout_padding2-bottom">
        <div class="row">
          <div class="col-md-7">
            <form action="https://formsubmit.co/samuelcauabarbosa114@gmail.com" method="POST">
              <div class="contact_form-container">
                <div>
                  ...
                  <div class="">
                    <input type="text" placeholder="Mensagem" name="message" class="message_input" required>
                  </div>
                  <div class="mt-5">
                    <button type="submit">
                      Enviar
            ...
            <div class="map-box">
              <div id="map">
                <div class="map-responsive">
                  <iframe
                    src="https://maps.google.com/maps?width=600&amp;height=300&amp;hl=en&amp;q=R.Antônio de Paula Assis,N:36&amp;t=&amp;z=20&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
      ...
      <div class="contact_items">
        ...
        <a
          href="https://www.google.com/maps/search/R.+Antônio+de+Paula+Assis,+N:36,+Natércia+37.524-000/@-22.1183519,-45.5210006,17z/data=!3m1!4b1">
          <div class="item ">
            <div class="img-box box-1">
            </div>
            <div class="detail-box">
              <p>
                R. Antônio de Paula Assis, N:36, Natércia 37.524-000
              </p>
            </div>
          </div>
        </a>
